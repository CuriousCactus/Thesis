...
\\[1\baselineskip]
\noindent{\textbf{HRMS} (ESI$^+$) The compound does not ionise.}\todo{works in LCMS see Lois283}
\\[1\baselineskip]
...
\compound{cmpd:TBSOcy5NH4T4Cip_SS} was obtained as a clear amorphous solid (67.1 mg, 90.9 $\mu$mol, 87.4 \%).
\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
