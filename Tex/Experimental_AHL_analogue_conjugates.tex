...
\\[1\baselineskip]
\noindent{\textbf{LRMS} (AP+) \textit{m}/\textit{z} / Da = 266.1, [M+H]$^+$ found, [\ce{C8H12BrNO2S}]$^+$ requires 266.0}
\\[1\baselineskip]
...
and \ce{K2CO3} (20 mg, 0.145 mmol, 1 eq.) were stirred in acetonitrile (2 mL) at 50 $^{\circ}$C under argon. After 24 h a further portion of \compound{cmpd:SHL4Br} (34.5 mg, 0.145 mmol, 1 eq.) was added. After another 24 h a further portion was added (69.0 mg, 0.290 mmol, 2 eq.). After another 24 h the temperature was raised so the mixture was at reflux. After a final 24 h the precipitate was filtered off and the filtrate was purified by column chromatography (\ce{SiO2}, 5-10\% MeOH/\ce{CH2Cl2}) followed by preparative HPLC (5-95\% acetonitrile/water over 20 min). \compound{cmpd:SHL4CipMe} was obtained as a pale cream amorphous solid (9.4 mg, 0.018 mmol, 12\%).
\\[1\baselineskip]
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	...
	2832 (C-H),
	1722 (ester C=O),
	1700 (thiolactone C=O),
	1670 (amide C=O),
	1617 (quinolone C=O)}
\\[1\baselineskip]
\noindent{\textbf{$^{1}$H NMR} (500 MHz, MeOD) $\delta$ / ppm = 
	8.53 (s, 1 H, \textit{ortho} to C(=O)OCH$_3$), 
	7.68 (d, \textit{J} = 13.4 Hz, 1 H, \textit{ortho} to F), 
	7.41 (d, \textit{J} = 7.3 Hz, 1 H, \textit{meta} to F), 
	4.67 (dd, \textit{J} = 12.9, 6.9 Hz, 1 H, C\underline{H}NH), 
	3.83 (s, 3 H, OC\underline{H}$_3$), 
	3.61 (tt, \textit{J} = 6.9, 4.1 Hz, 1 H, NC\underline{H}(CH$_2$)$_2$), 
	3.39 - 3.49 (m, 1 H, SC\underline{H}H), 
	3.26 - 3.33 (m, 5 H, SCH\underline{H} and CH$_2$CH$_2$CH$_2$N(CH$_2$C\underline{H}$_2$)CH$_2$C\underline{H}$_2$), 
	2.93 - 3.03 (m, 4 H, CH$_2$CH$_2$CH$_2$N(C\underline{H}$_2$)C\underline{H}$_2$), 
	2.79 (br. t, \textit{J} = 7.2, 7.2 Hz, 2 H, C(=O)CH$_2$CH$_2$C\underline{H}$_2$), 
	2.59 (dddd, \textit{J} = 12.4, 6.9, 5.4, 1.4 Hz, 1 H, SCH$_2$C\underline{H}H), 
	2.39 (t, \textit{J} = 7.20 Hz, 1 H, C(=O)C\underline{H}H), 
	2.38 (t, \textit{J} = 6.94 Hz, 1 H, C(=O)CH\underline{H}), 
	2.18 (qd, \textit{J} = 12.4, 7.0 Hz, 1 H, SCH$_2$CH\underline{H}), 
	1.97 (quin, \textit{J} = 7.2 Hz, 2 H, C(=O)CH$_2$C\underline{H}$_2$), 
...
\noindent{\textbf{$^{13}$C NMR} (126 MHz, MeOD) $\delta$ / ppm = 
	...
	154.7 (d, \textit{J} = 249.0 Hz, \textit{ipso} to F), 
	150.2 (s, \underline{C}H=CC(=O)OCH$_3$), 
	145.6 (d, \textit{J} = 10.6 Hz, \textit{ipso} to piperazine), 
	139.8 (\textit{para} to F), 
	123.5 (d, \textit{J} = 6.9 Hz, \textit{para} to piperazine), 
	113.1 (d, \textit{J} = 23.6 Hz, \textit{ortho} to C=O and \textit{ortho} to F), 
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	...
	3.31 (td, \textit{J} = 11.7, 5.3 Hz, 1 H, SC\underline{H}H), 
...
\compound{cmpd:SHL4T4Cip} was obtained as a white amorphous solid (16.5 mg, 25.9 $\mu$mol, 71\%).
\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	2919 (C-H),
	1713 (carboxylic acid C=O and thiolactone C=O),
	1658 (amide C=O),
	1627 (quinolone C=O),
	1616 (triazole)}
\\[1\baselineskip]
\noindent{\textbf{$^{1}$H NMR} (500 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	8.23 (d, \textit{J} = 8.5 Hz, 1 H, N\underline{H}), 
	7.90 (d, \textit{J} = 13.4 Hz, 1 H, \textit{ortho} to F), 
	7.84 (s, 1 H, C\underline{H}=CCH$_2$), 
	7.56 (d, \textit{J} = 7.5 Hz, 1 H, \textit{meta} to F), 
	4.59 (ddd, \textit{J} = 12.7, 8.4, 6.8 Hz, 1 H, C\underline{H}NH), 
	...
	3.32 (br t, \textit{J} = 4.1 Hz, 4 H, CH$_2$CH$_2$CH$_2$N(CH$_2$C\underline{H}$_2$)CH$_2$C\underline{H}$_2$), 
	3.27 (ddd, \textit{J} = 11.1, 6.9, 1.4 Hz, 1 H, SCH\underline{H}), 
	2.64 (t, \textit{J} = 7.6 Hz, 2 H, CH=CC\underline{H}$_2$), 
	2.57 (br t, \textit{J} = 4.7 Hz, 4 H, CH$_2$CH$_2$CH$_2$N(C\underline{H}$_2$)C\underline{H}$_2$), 
	2.34 - 2.44 (m, 3 H, SCH$_2$C\underline{H}H and CH=CCH$_2$CH$_2$CH$_2$C\underline{H}$_2$), 
	2.12 (t, \textit{J} = 7.9 Hz, 1 H, C(=O)C\underline{H}H), 
	2.12 (t, \textit{J} = 7.0 Hz, 1 H, C(=O)CH\underline{H}), 
	2.04 (m, 3 H, SCH$_2$CH\underline{H} and C(=O)CH$_2$C\underline{H}$_2$), 
	1.64 (quin, \textit{J} = 7.5 Hz, 2 H, CH=CCH$_2$C\underline{H}$_2$), 
	1.51 (quin, \textit{J} = 7.5 Hz, 2 H, CH=CCH$_2$CH$_2$C\underline{H}$_2$), 
...
\noindent{\textbf{$^{13}$C NMR} (126 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	153.1 (d, \textit{J} = 249.3 Hz, \textit{ortho} to F), 
	148.0 (\underline{C}H=CC(=O)OH), 
	146.9 (CH=\underline{C}CH$_2$), 
	145.3 (d, \textit{J} = 10.1 Hz, \textit{ipso} to piperazine), 
	139.2 (\textit{para} to F), 
	121.8 (\underline{C}H=CCH$_2$), 
	118.6 (d, \textit{J} = 7.7 Hz, \textit{para} to piperazine), 
	111.0 (d, \textit{J} = 23.3 Hz, \textit{ortho} to C=O and \textit{ortho} to F), 
	106.7 (\underline{C}C(=O)OH), 
	106.4 (d, \textit{J} = 2.9 Hz, \textit{meta} to C=O and \textit{meta} to F), 
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	3055 (C-H),
	1716 (carboxylic acid C=O and ester C=O),
	1696 (carbamate C=O and thiolactone C=O),
	1651 (amide C=O),
	1629 (quinolone C=O)}
	%no triazole
\\[1\baselineskip]
\noindent{\textbf{$^{1}$H NMR} (400 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	3.62 (br t, \textit{J} = 5.2 Hz, 4 H, C(=O)N(C\underline{H}$_2$)C\underline{H}$_2$), 
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3} d$_1$) $\delta$ / ppm = 
	...
	2.67 (br t, \textit{J} = 5.0 Hz, 4 H, C(=O)CH$_2$CH$_2$CH$_2$N(C\underline{H}$_2$)C\underline{H}$_2$), 
...
4\hyp{}Bromo\hyp{}\textit{N}\hyp{}(2\hyp{}methoxyphenyl)butanamide \compound{cmpd:2MeOA4Br} (2.05 g, 7.51 mmol, 1 eq.) and \ce{NaN3} (1.17 g, 18.0 mmol, 2.4 eq.) were refluxed in acetonitrile (100 mL) for 2 h. The mixture was cooled and filtered, and the fitrate was dry-loaded onto \ce{SiO2} and purified by column chromatography using a Combiflash (\ce{SiO2}, 8-14\% then held at 14\% EtOAc/P.E.). \compound{cmpd:2MeOA4N3} was obtained as an initially colourless liquid which slowly turned blue then black if left out on the bench (0.469 g, 2.00 mmol, 27\%).
\\[1\baselineskip]
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	...
	3.31 (br t, \textit{J} = 4.3 Hz, 4 H, C(=O)CH$_2$CH$_2$CH$_2$N(CH$_2$C\underline{H}$_2$)CH$_2$C\underline{H}$_2$), 
	2.73 (br t, \textit{J} = 4.5 Hz, 4 H, C(=O)CH$_2$CH$_2$CH$_2$N(C\underline{H}$_2$)C\underline{H}$_2$), 
...
\noindent{\textbf{$^{13}$C NMR} (101 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	...
	153.3 (d, \textit{J} = 250.1 Hz, \textit{ipso} to F), 
	148.4 (\underline{C}=CC(=O)OCH$_3$), 
	144.1 (d, \textit{J} = 10.1 Hz, \textit{ipso} to piperazine), 
	139.4 (\textit{ipso} to NH), 
	138.0 (\textit{para} to F), 
	129.6 (\textit{meta} to NH and \textit{meta} to OCH$_3$), 
	123.3 (d, \textit{J} = 6.4 Hz, \textit{para} to piperazine), 
	113.4 (d, \textit{J} = 23.3 Hz, \textit{ortho} to C=O and \textit{ortho} to F), 
...
\subsection{(1\textit{S},2\textit{S})\hyp{}2\hyp{}(((\allowbreak \textit{S})\hyp{}1\hyp{}Phenylethyl)am\allowbreak ino)cyclopentan\hyp{}1\hyp{}ol \compound{cmpd:HOcy5NHMeBn_SSS} and (1\textit{R},2\textit{R})\hyp{}2\hyp{}(((\allowbreak \textit{S})\hyp{}1\hyp{}phenylethyl)amino)\allowbreak cyclopentan\hyp{}1\hyp{}ol \compound{cmpd:HOcy5NHMeBn_RRS}}
...
\\[1\baselineskip]
\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = 66-72 (hexane, EtOAc, TEA)}
\\[1\baselineskip]
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	3150 (br, O-H),
	2951 (C-H),
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm =
	...
	1.77 (dtd, \textit{J} = 12.9, 7.9, 4.9 Hz, 1 H, C\underline{H}HCHNH), 
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = -23.9, lit. = -22.1 (\textit{c} / g(100 mL)$^{-1}$ = 0.96 , MeOH)} %actually different conc.
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = -92.8, lit. = -76.8 (\textit{c} / g(100 mL)$^{-1}$ = 1.19, MeOH)}
\\[1\baselineskip]
...
\\[1\baselineskip]
\noindent{\textbf{$^{1}$H NMR} (400 MHz, MeOD) $\delta$ / ppm =
	3.77 (ddd, \textit{J} = 6.6, 6.2, 5.6, 1 H, C\underline{H}OH), 
	3.00 (td, \textit{J} = 7.4, 5.6 Hz, 1 H, C\underline{H}NH$_2$), 
	2.00 (dtd, \textit{J} = 13.0, 7.7, 5.6 Hz, 1 H, C\underline{H}HCHNH$_2$), 
	1.97 (ddt, \textit{J} = 13.0, 8.7, 6.4 Hz, 1 H, C\underline{H}HCHOH), 
	1.64 - 1.77 (m, 2 H, C\underline{H}$_2$CH$_2$CHOH), 
	1.53 (ddt, \textit{J} = 13.0, 9.5, 6.2 Hz, 1 H, CH\underline{H}CHOH), 
	1.37 (ddt, \textit{J} = 12.8, 8.5, 7.7 Hz, 1 H, CH\underline{H}CHNH$_2$)}
\\[1\baselineskip]
\noindent{\textbf{$^{13}$C NMR} (101 MHz, MeOD) $\delta$ / ppm = 
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = 33.4, lit. = 29.7 (\textit{c} / g(100 mL)$^{-1}$ = 0.5, EtOH)}
\\[1\baselineskip]
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, MeOD) $\delta$ / ppm = 
	3.77 (ddd, \textit{J} = 6.6, 6.2, 5.6, 1 H, C\underline{H}OH), 
	3.00 (td, \textit{J} = 7.3, 5.6 Hz, 1 H, C\underline{H}NH$_2$), 
	2.00 (dtd, \textit{J} = 13.0, 7.7, 5.6 Hz, 1 H, C\underline{H}HCHNH$_2$), 
	1.97 (ddt, \textit{J} = 13.0, 8.7, 6.6 Hz, 1 H, C\underline{H}HCHOH), 
	1.63 - 1.77 (m, 2 H, C\underline{H}$_2$CH$_2$CHOH), 
	1.53 (ddt, \textit{J} = 13.0, 9.5, 6.2 Hz, 1 H, CH\underline{H}CHOH), 
	1.37 (ddt, \textit{J} = 13.0, 8.3, 7.8 Hz, 1 H, CH\underline{H}CHNH$_2$)}
\\[1\baselineskip]
\noindent{\textbf{$^{13}$C NMR} (101 MHz, MeOD) $\delta$ / ppm = 
...
\\[1\baselineskip]	
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = -30.9, lit. = -32.9 (\textit{c} / g(100 mL)$^{-1}$ = 1.5 , EtOH)}
\\[1\baselineskip]
The data are consistent with the literature\cite{Schiffers2006,Overman1985}.
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	...
	3.96 (q, \textit{J} = 6.6 Hz, 1 H, C\underline{H}OH), 
	3.83 (tdd, \textit{J} = 8.5, 6.0, 4.6 Hz, 1 H, C\underline{H}NH), 
	3.37 (t, \textit{J} = 6.4 Hz, 2 H, C\underline{H}$_2$N$_3$), 
	2.31 (t, \textit{J} = 7.2 Hz, 2 H, C\underline{H}$_2$C=O), 
	...
	1.42 (dq, \textit{J} = 12.8, 8.3 Hz, 1 H, CH\underline{H}CHNH)}
\\[1\baselineskip]
\noindent{\textbf{$^{13}$C NMR} (101 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	173.8 (\underline{C}=O), 
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm =
	...
	3.75 (tdd, \textit{J} = 8.4, 6.6, 4.4 Hz, 1 H, C\underline{H}NH), 
	3.28 (t, \textit{J} = 6.6 Hz, 2 H, C\underline{H}$_2$N$_3$), 
	2.23 (t, \textit{J} = 7.3 Hz, 2 H, C\underline{H}$_2$C=O), 
	2.04 (dtd, \textit{J} = 13.0, 8.0, 4.9 Hz, 1 H, C\underline{H}HCHNH), 
	1.92 (dtd, \textit{J} = 13.0, 7.6, 5.8 Hz, 1 H, C\underline{H}HCHOH), 
	1.84 (quin, \textit{J} = 7.0 Hz, 2 H, C\underline{H}$_2$CH$_2$N$_3$), 
	1.59 - 1.77 (m, 2 H, C\underline{H}$_2$CH$_2$CHOH), 
	1.54 (ddt, \textit{J} = 12.7, 9.0, 6.7 Hz, 1 H, CH\underline{H}CHOH), 
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	2938 (C-H),
	1721 (ester C=O),
	1621 (amide C=O and quinolone C=O)}
\\[1\baselineskip]
\noindent{\textbf{$^{1}$H NMR} (500 MHz, DMSO d$_6$) $\delta$ / ppm = 
	8.44 (s, 1 H, \textit{ortho} to C(=O)OC\underline{H}$_3$), 
	7.75 (d, \textit{J} = 13.5 Hz, 1 H, \textit{ortho} to F), 
	7.69 (d, \textit{J} = 6.9 Hz, 1 H, CHN\underline{H}), 
	7.43 (d, \textit{J} = 7.6 Hz, 1 H, \textit{meta} to F), 
	4.73 (br s, 1 H, CHO\underline{H}), 
	3.77 - 3.81 (m, 1 H, C\underline{H}OH), 
	3.74 - 3.77 (m, 1 H, C\underline{H}NH), 
	3.73 (s, 3 H, C\underline{H}$_3$), 
	3.65 (tt, \textit{J} = 6.9, 4.0 Hz, 1 H, NC\underline{H}(CH$_2$)$_2$), 
	3.24 (br. t, \textit{J} = 4.2 Hz, 4 H, CH$_2$N(CH$_2$C\underline{H}$_2$)CH$_2$C\underline{H}$_2$), 
	2.55 (br t, \textit{J} = 5.0 Hz, 4 H, CH$_2$N(C\underline{H}$_2$)C\underline{H}$_2$), 
	2.32 (t, \textit{J} = 7.2 Hz, 2 H, C\underline{H}$_2$N(CH$_2$)CH$_2$), 
	2.10 (t, \textit{J} = 7.4 Hz, 2 H, C\underline{H}$_2$CH$_2$CH$_2$N(CH$_2$)CH$_2$), 
	1.92 (dddd, \textit{J} = 13.0, 8.7, 7.3, 6.0 Hz, 1 H, C\underline{H}HCHNH), 
	1.77 (ddt, \textit{J} = 12.6, 8.9, 6.3 Hz, 1 H, C\underline{H}HCHOH), 
	1.68 (quin, \textit{J} = 7.4 Hz, 2 H, C\underline{H}$_2$CH$_2$N(CH$_2$)CH$_2$), 
	1.53 - 1.64 (m, 2 H, C\underline{H}$_2$CH$_2$CHOH), 
	1.42 (ddt, \textit{J} = 12.9, 8.4, 5.2 Hz, 1 H, CH\underline{H}CHOH), 
	1.31 (ddt, \textit{J} = 13.0, 8.6, 6.4 Hz, 1 H, CH\underline{H}CHNH), 
...
\noindent{\textbf{$^{13}$C NMR} (126 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	152.6 (d, \textit{J} = 247.4 Hz, \textit{ipso} to F), 
	148.2 (\underline{C}=CC(=O)OCH$_3$), 
	143.9 (d, \textit{J} = 10.3 Hz, \textit{ipso} to piperazine), 
	138.1 (\textit{para} to F), 
	121.7 (d, \textit{J} = 6.4 Hz, \textit{para} to piperazine), 
	111.5 (d, \textit{J} = 23.0 Hz, \textit{ortho} to C=O and \textit{ortho} to F), 
...
%%LMO\hyp{}3\hyp{}003 (SN2 method, messy, chucked), LMO\hyp{}2\hyp{}091 (done, worked up but HOBt contamination after column), LMO-2\-093 (done)
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	1.42 (ddt, \textit{J} = 13.1, 8.2, 5.3 Hz, 1 H, CH\underline{H}CHOH), 
...
%	7.78 (d, \textit{J} = 13.5 Hz, 1 H, \textit{ortho} to F), 
%	7.45 (d, \textit{J} = 7.4 Hz, 1 H, \textit{meta} to F), 
%	4.02 (dt, \textit{J} = 11.1, 8.2 Hz, 1 H, C\underline{H}NH), 
%	3.73 (s, 3 H, C\underline{H}$_3$), 
%	3.65 (tt, \textit{J} = 6.9, 3.9 Hz, 1 H, NC\underline{H}(CH$_2$)$_2$), 
...
%	152.6 (d, \textit{J} = 246.6 Hz, \textit{ipso} to F), 
%	148.4 (\underline{C}=CC(=O)OCH$_3$), 
%	138.1 (\textit{para} to F), 
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	7.91 (d, \textit{J} = 13.3 Hz, 1 H, \textit{ortho} to F), 
	7.84 (s, 1 H, C\underline{H}=CCH$_2$), 
	7.74 (d, \textit{J} = 6.7 Hz, 1 H, CHN\underline{H}), 
	7.56 (d, \textit{J} = 7.4 Hz, 1 H, \textit{meta} to F), 
	4.71 (d, \textit{J} = 3.7 Hz, 1 H, CHO\underline{H}), 
	4.29 (t, \textit{J} = 6.6 Hz, 2 H, C\underline{H}$_2$NCH=C), 
	3.82 (tt, \textit{J} = 6.5, 4.3 Hz, 1 H, NC\underline{H}(CH$_2$)$_2$), 
	...
	1.89 (dddd, \textit{J} = 12.8, 8.9, 7.4, 5.8 Hz, 1 H, C\underline{H}HCHNH), 
	1.75 (ddt, \textit{J} = 12.7, 9.0, 6.2 Hz, 1 H, C\underline{H}HCHOH), 
	1.48 - 1.68 (m, 6 H, CH=CCH$_2$C\underline{H}$_2$C\underline{H}$_2$ and C\underline{H}$_2$CH$_2$CHOH), 
	1.40 (ddt, \textit{J} = 13.0, 8.3, 5.3 Hz, 1 H, CH\underline{H}CHOH), 
...
\noindent{\textbf{$^{13}$C NMR} (101 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	166.0 (\underline{C}(=O)OH), 
	153.0 (d, \textit{J} = 249.6 Hz, \textit{ipso} to F), 
	148.1 (\underline{C}=CC(=O)OH), 
	146.7 (CH=\underline{C}CH$_2$), 
	145.2 (d, \textit{J} = 8.3 Hz, \textit{ipso} to piperazine), 
	139.2 (\textit{para} to F), 
	121.8 (N\underline{C}H=CCH$_2$), 
	118.7 (\textit{para} to piperazine), 
	111.0 (d, \textit{J} = 23.2 Hz, \textit{ortho} to C=O and \textit{ortho} to F), 
	106.7 (\underline{C}C(=O)OH), 
...
The mixture was stirred at room temperature under argon for 16 h. Water (30 mL) and \ce{CH2Cl2} (30 mL) were added, the organic layer was separated and the aqueous layer was extracted again with \ce{CH2Cl2} (4$\times$30 mL). The combined organic layers were dried with \ce{MgSO4} and evaporated under reduced pressure. The residue was purified by preparative HPLC (5-95\% acetonitrile/water over 20 min). The combined pure fractions were evaporated under reduced pressure and then partitioned between \ce{NaHCO3} (aq., sat., 10 mL) and 10\% \textit{i}-PrOH/\ce{CHCl3} (10 mL). The organic layer was dried with \ce{MgSO4} and evaporated under reduced pressure.
\compound{cmpd:HOcy5NH4T4Cip_RR} was obtained as a white amorphous solid (17.6 mg, 28.2 $\mu$mol, 27\%).
\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm =
	...
	1.97 (ddq, \textit{J} = 8.8, 7.0, 6.0 Hz, 1 H, C\underline{H}HCHOSi), 
	1.74 - 1.86 (m, 2 H, C\underline{H}$_2$CH$_2$CHOSi), 
	1.64 - 1.74 (m, 1 H, CH\underline{H}CHOSi), 
	1.58 (ddt, \textit{J} = 13.2, 9.1, 6.0 Hz, 1 H, CH\underline{H}CHNH$_2$), 
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = 40.0 (\textit{c} / g(100 mL)$^{-1}$ = 0.05 , MeOH)}
The compound has not been reported previously.
...
A solution of \ce{CuSO4} and THPTA (104 $\mu$l, 10.4 $\mu$mol, 0.1 eq. 100 mM, aq.) was added, followed by a solution of sodium ascorbate (208 $\mu$l, 20.8 $\mu$mol, 0.2 eq., 100 mM, aq.). 
The mixture was stirred at room temperature under argon for 16 h, then solvent was removed under reduced pressure. The residue was partitioned between water (10 mL) and \ce{CH2Cl2} (10 mL), the organic layer was separated and the aqueous layer was extracted again with \ce{CH2Cl2} (10 mL). The combined organic layers were dried with \ce{MgSO4} and evaporated under reduced pressure. 
\compound{cmpd:TBSOcy5NH4T4Cip_SS} was obtained as a clear amorphous solid (67.1 mg, 90.9 $\mu$mol, 87\%).
\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	...
	2929 (C-H),
	2856 (C-H),
	1741 (carboxylic acid C=O), %a bit high?
	1640 (amide C=O),
	1627 (quinolone C=O),
	1612 (triazole)}
\\[1\baselineskip]
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	...
	1.42 (dq, \textit{J} = 12.5, 8.4 Hz, 1 H, CH\underline{H}CHNH)}
\\[1\baselineskip]
\noindent{\textbf{$^{13}$C NMR} (101 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	173.8 (\underline{C}=O), 
...
%%LMO\hyp{}2\hyp{}092 (Schotten Bauman, doesn't work), LMO\hyp{}2\hyp{}094 (TEA \ce{CH2Cl2}, done), LMO\hyp{}3\hyp{}001 (done)
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	2962 (C-H),
	2831 (C-H),
	1732 (\textit{t}-Bu ester C=O)
	1717 (ciprofloxacin ester C=O),
	1621 (quinolone C=O)}
\\[1\baselineskip]
\noindent{\textbf{$^{1}$H NMR} (400 MHz, \ce{CDCl3}) $\delta$ / ppm = 
...
\\[1\baselineskip]
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	1723 (ciprofloxacin ester C=O),
	1699 (alkyl carboxylic acid C=O),
	1673 (TFA C=O),
	%1626 (),
	1615 (quinolone C=O)}
\\[1\baselineskip]
...
Cyclohexene oxide \compound{cmpd:Ocy6} (10 mL, 9.70 g, 98.8 mmol, 1 eq.), \ce{NH3} (90 mL, 35\% w/w aq., 27.7 g, 791 mmol, 8 eq.) and MeOH (100 mL) were stirred at r.t. for 72 h. The solvent was removed by blowing a stream of \ce{N2} over it, followed by evaporation under high vacuum. %\todo{phrasing?}.
\compound{cmpd:HOcy6NH2} was obtained as a white amorphous solid (9.90 g, 85.2 mmol, 86\%)
\\[1\baselineskip]
...
\noindent{\textbf{$^{13}$C NMR} (101 MHz, \ce{CDCl3}) $\delta$ / ppm = 
	...
	24.7 (\underline{C}H$_2$CH$_2$CHNH$_2$), 
...
\\[1\baselineskip]
\noindent{\textbf{HRMS} (ESI$^+$) \textit{m}/\textit{z} / Da = 529.2827, [M+H]$^+$ found, [\ce{C28H38FN4O5}]$^+$ requires 529.2826}
\\[1\baselineskip]
The compound has not been reported previously.
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	2.26 (dtt, \textit{J} = 13.4, 2.6, 1.6 Hz, 1 H, CH\underline{H}C(=O)CHNH), 
	2.16 - 2.22 (m, 2 H, C(=O)C\underline{H}$_2$CH$_2$CH$_2$N), 
	2.12 (ddq, \textit{J} = 12.7, 6.0, 2.8 Hz, 1 H, C\underline{H}HCHNH), 
	2.00 (ddquin, \textit{J} = 13.2, 6.0, 2.9 Hz, 1 H, C\underline{H}HCH$_2$C(=O)), 
...
The mixture was stirred at r.t. under argon for 16 h. Water (50 mL) and 10\% \textit{i}-PrOH/\ce{CHCl3} (50 mL) were added, then the organic layer was separated, dried with \ce{MgSO4} and evaporated under reduced pressure. The residue was purified by preparative HPLC (5-70\% acetonitrile/water over 15 min). 
The combined pure fractions were evaporated under reduced pressure and then partitioned between \ce{NaHCO3} (aq., sat., 50 mL) and 10\% \textit{i}-PrOH/\ce{CHCl3} (50 mL). The organic layer was dried with \ce{MgSO4} and evaporated under reduced pressure.
\compound{cmpd:HOcy6NH4T4Cip} was obtained as a white amorphous solid (30.3 mg, 47.5 $\mu$mol, 49\%).
\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	3.31 (br t, \textit{J} = 4.8 Hz, 4 H, CH=CCH$_2$CH$_2$CH$_2$N(CH$_2$C\underline{H}$_2$)CH$_2$C\underline{H}$_2$), 
	3.14 - 3.24 (m, 1 H, C\underline{H}OH), 
	2.63 (t, \textit{J} = 7.4 Hz, 2 H, CH=CC\underline{H}$_2$), 
	2.56 (br t, \textit{J} = 4.6 Hz, 4 H, CH=CCH$_2$CH$_2$CH$_2$N(C\underline{H}$_2$)C\underline{H}$_2$), 
	...
	1.54 - 1.60 (m, 2 H, C\underline{H}HCH$_2$OH), 
...
1\hyp{}Cyclopropyl\hyp{}6\hyp{}fluoro\hyp{}7\hyp{}(4\hyp{}(4\hyp{}(1\hyp{}(4\hyp{}(((\textit{trans})\hyp{}2\hyp{}hydroxycyclohexyl)amino)\hyp{}4\hyp{}oxobutyl)\hyp{}1H\hyp{}1,2,3\hyp{}triazol\hyp{}4\hyp{}yl)but\allowbreak yl)piperazin\hyp{}1\hyp{}yl)\hyp{}4\hyp{}oxo\hyp{}1,4\hyp{}dihydroquinoline\hyp{}3\hyp{}carboxylic acid \compound{cmpd:HOcy6NH4T4Cip} (15.0 mg, 23.6 mmol, 1 eq.) and Dess-Martin periodinane (35.0 mg, 82.5 mmol, 3.5 eq.) were stirred in \ce{CH2Cl2} (3 mL) at r.t. for 4 h. The solvent was removed under reduced pressure and the residue was purified by preparative HPLC (5-70\% acetonitrile/water over 15 min). The combined pure fractions were evaporated under reduced pressure, then \ce{NaHCO3} (aq., sat., 30 mL) and 10\% \textit{i}-PrOH/\ce{CHCl3} (30 mL) were added. The organic layer was dried with \ce{MgSO4} and evaporated under reduced pressure. \compound{cmpd:Ocy6NH4T4Cip} was obtained as a clear gum (11.7 mg, 18.4 $\mu$mol, 78\%).
%\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	2941 (C-H),
	2860 (C-H),
	1720 (carboxylic acid C=O and ketone C=O),
	1657 (amide C=O),
	1626 (quinolone C=O),
	1614 (triazole)}
\\[1\baselineskip]
\noindent{\textbf{$^{1}$H NMR} (500 MHz, DMSO d$_6$) $\delta$ / ppm = 
	8.65 (s, 1 H, \textit{ortho} to C(=O)OH), 
	7.94 (d, \textit{J} = 7.7 Hz, 1 H, N\underline{H}), 
	7.88 (d, \textit{J} = 13.4 Hz, 1 H, \textit{ortho} to F), 
	7.85 (s, 1 H, C\underline{H}=CCH$_2$), 
	7.55 (d, \textit{J} = 7.3 Hz, 1 H, \textit{meta} to F), 
	4.40 (dddd, \textit{J} = 12.8, 7.6, 6.1, 1.1 Hz, 1 H), 
	4.31 (t, \textit{J} = 7.0 Hz, 1 H, C(=O)CH$_2$CH$_2$C\underline{H}HN), 
	4.31 (t, \textit{J} = 6.9 Hz, 1 H, C(=O)CH$_2$CH$_2$CH\underline{H}$_2$N), 
	...
	2.56 (br t, \textit{J} = 5.0, 5.0 Hz, 4 H, CH$_2$CH$_2$CH$_2$N(C\underline{H}$_2$)C\underline{H}$_2$), 
	2.45 - 2.52 (m, 1 H, C\underline{H}HC(=O)), 
	2.38 (t, \textit{J} = 7.1 Hz, 2 H, CH=CCH$_2$CH$_2$CH$_2$C\underline{H}$_2$N), 
	2.25 (dtt, \textit{J} = 13.4, 2.6, 1.6 Hz, 1 H, CH\underline{H}C(=O)), 
...
\noindent{\textbf{$^{13}$C NMR} (126 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	166.0 (\underline{C}(=O)OH), 
	153.0 (d, \textit{J} = 246.4 Hz, \textit{ipso} to F), 
	147.9 (\underline{C}=CC(=O)OH), 
	146.8 (CH=\underline{C}CH$_2$), 
	145.1 (d, \textit{J} = 10.1 Hz, \textit{ipso} to piperazine), 
	139.1 (\textit{para} to F), 
	121.7 (N\underline{C}H=CCH$_2$), 
	118.7 (d, \textit{J} = 6.9 Hz, \textit{para} to piperazine), 
	110.9 (d, \textit{J} = 23.0 Hz, \textit{ortho} to C=O and \textit{ortho} to F), 
