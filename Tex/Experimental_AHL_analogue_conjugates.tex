...
\compound{cmpd:HOcy6NH2} was obtained as white needles (9.90 g, 85.2 mmol, 86.2 \%)
\\[1\baselineskip]
\noindent{\textbf{TLC} \textit{R$_f$} = 0.04 (30 \% MeOH/\ce{CH2Cl2})}
\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
%\\[1\baselineskip]\todo{get??}
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	3350.4 (N-H),
	3306.2 (br, O-H),
	2926.9 (C-H),
