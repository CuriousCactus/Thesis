...
High Resolution Mass Spectra (HRMS) were recorded using a Micromass LCT Premier spectrometer or a Waters Vion IMS-QTOF spectrometer and reported mass values are within $\pm$ 5 ppm mass units. Low Resolution Mass Spectra (LRMS) were recorded on an Agilent 1200 series LC with an ESCi Multi-Mode Ionisation Waters ZQ spectrometer or a Waters ACQUITY H-Class UPLC with an ESCi Multi-Mode Ionisation Waters SQD2 mass spectrometer.
...
%method. Low Resolution Mass Spectra (LRMS) were recorded on an Agilent 
