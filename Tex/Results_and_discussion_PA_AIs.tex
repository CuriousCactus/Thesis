...
\begin{scheme}[H]
	\begin{center}
		...
		d) i) \ce{NaNO2}, HCl, water, 0 $^{\circ}$C. ii) \ce{NaN3}, water, r.t., 41\%.
...
\hline 
\ce{SnCl2.2H2O}, MeOH, r.t., 18 h & No reaction \\ 
\hline 
\ce{H2}, Pd/C, MeOH, 3 atm, r.t., 4 h. & Product \compound{cmpd:amPQS}, >99\% yield \\ 
\hline 
...
\begin{scheme}[H]
	\begin{center}
		...
		b) \textit{N},\textit{O}-dimethylhydroxyl amine hydrochloride, \ce{K2CO3}, toluene, water, - 5 $^{\circ}$C to r.t., 30 min, 71\%.
		c) THF, 0 $^{\circ}$C to r.t., 15 h, 96\%.
		d) \compound{cmpd:5naa}, \ce{K2CO3}, DMF, 90 $^{\circ}$C, 1 h, then \compound{cmpd:Clnon}, r.t., 18 h, >99\%.
		e) Polyphosphoric acid, 90 $^{\circ}$C, 5.5 h, 40\%.
		f) \ce{H2}, \ce{PtO2}, MeOH, 1 atm, r.t., 45 min, 80\%.
		g) i) \ce{NaNO2}, HCl, water, 0 $^{\circ}$C, 50 min. ii) \ce{NaN3}, water, r.t., 4 h, 28\% over two steps.
...
N$_3$-C$_2$-HSL \compound{cmpd:HL2N3} (the azido derivative of C$_4$-HSL with a C$_2$ chain, see \ref{sch:HL2N3_synth}) has previously been prepared by Stacy \textit{et al.} \cite{Stacy2013}. Their synthesis was followed, starting with the cyclisation of \textsc{l}-methionine \compound{cmpd:LM} using bromoacetic acid to form the HSL HBr salt \compound{cmpd:HLHBr}. The disappointing yield can be attributed to difficulties in precipitating the final product. The HSL HBr salt \compound{cmpd:HLHBr} was then converted by a biphasic one-pot process to N$_3$-C$_2$-HSL \compound{cmpd:HL2N3} using bromoacetyl bromide \compound{cmpd:Br2Br} and \ce{NaN3}. 
...
\begin{scheme}[H]
	\begin{center}
		...
		a) Bromoacetic acid, \textit{i}-PrOH:water:AcOH (5:5:2), r.t., 18 h, 41\%.
		b) \ce{NaN3}, \ce{NaHCO3}, water/\ce{CH2Cl2}, r.t., 18 h, 41\%.
		\label{sch:HL2N3_synth}}
	\end{center}
\end{scheme}

It was hoped that this procedure could also be used to produce the C$_4$ and C$_6$ derivatives, however, attempts to convert HSL \compound{cmpd:LM} to N$_3$-C$_4$-HSL \compound{cmpd:HL4N3} using 4-bromobutyryl chloride \compound{cmpd:Cl4Br} produced a complex mixture of products. This is likely to be because the S$_N$2 reaction in which the azide anion displaces bromine is slower for the C$_4$ derivative as the bromine atom being displaced is no longer adjacent to a carbonyl group. In addition, the longer chain length allows intramolecular cyclisation of the bromide with the secondary amide. 
...
\begin{scheme}[H]
	\begin{center}
		...
		a) Bromoacetic acid, \textit{i}-PrOH:water:AcOH (5:5:2), r.t, 18 h, 41\%.
		b) \ce{NaHCO3}, water/\ce{CH2Cl2}, r.t., 18 h, \compound{cmpd:HL4Br}: 80\%, \compound{cmpd:HL6Br}: 66\%.
