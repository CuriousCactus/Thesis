...
\begin{scheme}[H]
	\begin{center}
		...
		\caption{Synthesis of Br-C$_4$-HCTL \compound{cmpd:SHL4Br}. a) \ce{NaHCO3}, \ce{CH2Cl2}, \ce{H2O}, 0 $^{\circ}$C, 1 h, 88\%.\label{sch:SHL4Br_synth}}
	\end{center}
\end{scheme}
...
\begin{scheme}[H]
	\begin{center}
		...
		\caption{
			...
			b) \ce{CuSO4}, THPTA, sodium ascorbate, \ce{H2O}, \textit{t}-BuOH, DMSO, r.t., 7 d, 71\%.
