...
\begin{figure}[H]
	\begin{center}
		...
		\caption{
		C$_4$-HSL \compound{cmpd:HL4} and C$_4$-HCTL \compound{cmpd:SHL4}. Note that Ganguly et al. tested the \textit{S} enantiomer of C$_4$-HCTL \compound{cmpd:SHL4}, but used a racemic mixture in their HCTL-CipMe conjugate.
		\label{fig:HL_SHL}}
	\end{center}
\end{figure}
...
\hline 
 ...
 & Strong agonist against LasR, comparable activity to native ligand\cite{Smith2003,Boursier2018,Passador1996,McInnis2011}. \\ 
...
\hline 
 \vspace{5px}\includegraphics[scale=1]{2MeOA_head} & Not yet studied & Not yet studied \\  
\hline 
 \vspace{5px}\includegraphics[scale=1]{3MeOA_head} & Partial agonist\cite{Hodgkinson2012a} & Strong antagonist\cite{Hodgkinson2012a} \\ 
\hline 
\end{tabular}
...
\hline 
 \vspace{5px}\includegraphics[scale=1]{HOcy5_R_head} & & \\ 
\hline 
 \vspace{5px}\includegraphics[scale=1]{Ocy5_S_head} & & \\ 
\hline 
 \vspace{5px}\includegraphics[scale=1]{Ocy5_R_head} & & \\
\hline 
 \vspace{5px}\includegraphics[scale=1]{HOcy6_S_head} & & \\ 
\hline 
 \vspace{5px}\includegraphics[scale=1]{HOcy6_R_head} & & \\ 
\hline 
 \vspace{5px}\includegraphics[scale=1]{Ocy6_S_head} & & \\ 
\hline 
 \vspace{5px}\includegraphics[scale=1]{Ocy6_R_head} & & \\ 
\hline
\end{tabular}
\caption{Click reactions attempted.\label{tbl:Clicks_AHLs_Cip}} 
\end{table}
