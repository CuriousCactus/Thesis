...
Alkynyl ciprofloxacin derivative \compound{cmpd:Y4Cip} (see \ref{fgr:Cip_anas}) was synthesised in this study (see \ref{sec:Y4Cip}), and two cleavable alkynyl ciprofloxacin derivatives \compound{cmpd:Y4HCip} and \compound{cmpd:Y4MeCip} were synthesised by Dr Eddy Sotelo and combined with the azido HSL derivatives described above to create cleavable conjugates (see \ref{sec:cleavable}).
