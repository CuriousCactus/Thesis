...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
\todo{please ignore the wandering ledgends and confusing compound codes, these graphs will be updated when I've settled on the ordering of compounds in the thesis}
\begin{figure}[H]
	\begin{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=\textwidth]{PAO1_5h.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=\textwidth,trim={1cm 1cm 1cm 1cm},clip]{PAO1_5h.pdf}
		\caption{PAO1 OD readings at 5 h for the autoinducer-antibiotic conjugates.\label{fgr:PAO1_5h}}
	\end{center}
\end{figure}
