...
\subsubsubsection{Protection of the alcohol}
...
\begin{scheme}[H]
	\begin{center}
		...
		\caption{The synthesis of TBDMS protected (1\textit{S},2\textit{S})-2-aminocyclopentan-1-ol \compound{cmpd:TBSOcy5NH2_SS}. 
...
\subsubsubsection{Bromide synthesis}
...
\subsubsubsection{Azide synthesis by one-pot reaction}
...
\subsubsubsection{Click reaction}
