...
Quorum sensing in \textit{P. aeruginosa} involves a complex interplay of five signalling molecules (see \ref{fgr:PA_autoinducers}) and various proteins (see \ref{fgr:PA_QS})\cite{Guo2014,Dubern2008,Hodgkinson2011,Jimenez2012}.
These can be broken down into three main, interacting systems: Las, Rhl and Pqs\cite{Pesci1999}.
...
3-oxo-C$_{12}$-HSL \compound{cmpd:HLO12} binds LasR\cite{Gambello1991}, and this complex upregulates the production of LasI (thus causing autoinduction\cite{Pesci1997}) as well as elastase, LasA protease, alkaline protease, exotoxin A \cite{Gambello1993} and HCN\cite{Pessi2000}. 
The LasR complex is also important in late-stage biofilm formation\cite{Sauer2002}, and upregulates the Rhl\cite{Ochsner1995} and Pqs systems\cite{Gallagher2002,Wade2005}.

In the Rhl system, RhlI\cite{Brint1995} synthesises the C$_4$-HSL \compound{cmpd:HL4}\cite{Pearson1995} autoinducer. 
C$_4$-HSL \compound{cmpd:HL4} binds RhlR\cite{Winson1995}, and this complex upregulates the production of RhlI (again causing autoinduction)\cite{Pesci1997}, pyocyanin\cite{Hassett1999,Latifi1995}, elastase\cite{Hassett1999}, rhamnolipids\cite{Hassett1999}, LasA protease\cite{Brint1995}, LecA\cite{Winzer2000}, HCN\cite{Pessi2000,Latifi1995}, haemolysin\cite{Latifi1995} and alkaline protease\cite{Latifi1995}.
...
as production of both RhlR and RhlI is upregulated by the LasR complex\cite{Ochsner1995} 
...
The PqsR-PQS complex upregulates the production of pyocyanin\cite{Gallagher2002,Diggle2007}, pyoverdine\cite{Diggle2007}, HCN\cite{Deziel2005}, elastase\cite{Pesci1999}, chitinase\cite{Deziel2005} and LecA\cite{Diggle2003}, as well as increasing biofilm production\cite{Diggle2003} and vesicle formation\cite{Mashburn2009}.
