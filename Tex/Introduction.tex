...
In addition to the conjugates described above, a second collection of cleavable conjugates was designed.
These were based on the cleavable pyochelin–norfloxacin conjugates synthesised by Rivault \textit{et al.}\cite{Rivault2007}.
