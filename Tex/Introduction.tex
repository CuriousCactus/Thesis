...
One of the most well-studied examples of quorum sensing is in \textit{P. aeruginosa}.
...
\textit{P. aeruginosa} has a low susceptibility to many antibiotics and readily acquires antibiotic resistance by mutation or horizontal gene transfer\cite{cornelis2008pseudomonas}.
...
\textit{P. aeruginosa} uses quorum sensing to coordinate biofilm formation, swarming motility and virulence\cite{Guo2014,Dubern2008}. 
The autoinducers used by \textit{P. aeruginosa} are shown in \ref{fgr:PA_autoinducers}.
...
Quorum sensing in \textit{P. aeruginosa} involves a complex interplay of five signalling molecules and various proteins (see \ref{fgr:PA_QS})\cite{Dubern2008,Hodgkinson2011,Jimenez2012}.
These can be broken down into three main, interacting systems: Las, Rhl and Pqs.

In the Las system, LasI synthesises 3-oxo-C$_{12}$-HSL \compound{cmpd:HLO12} as its autoinducer. 3-oxo-C$_{12}$-HSL \compound{cmpd:HLO12} binds LasR, and this complex upregulates LasI production (thus causing autoinduction) as well as genes producing elastase, LasA protease, alkaline protease and exotoxin A \cite{Gambello1993}, and the Rhl and Pqs systems.

In the Rhl system, RhlI synthesises C$_4$-HSL \compound{cmpd:HL4} as its autoinducer. C$_4$-HSL \compound{cmpd:HL4} binds RhlR, and this complex upregulates RhlI production (thus causing autoinduction). Production of both RhlR and RhlI is also upregulated by the LasR complex, and so the Las system has control over the Rhl system. The RhlR complex also upregulates genes involved in the production of pyocyanin, elastase, rhamnolipids\cite{Hassett1999}, LecA, HCN and alkaline proteases\cite{blah}.

In the Pqs system, the main autoinducer, PQS \compound{cmpd:PQS}, is synthesised by enzymes encoded by multiple gene clusters. The \textit{pqsABCDE}\cite{Drees2015,Lin2018} and \textit{phnAB}\cite{Farrow2007} clusters produce enzymes responsible for the synthesis of the precursor HHQ \compound{cmpd:HHQ}, and PqsH converts HHQ \compound{cmpd:HHQ} to PQS \compound{cmpd:PQS}. 
PQS \compound{cmpd:PQS} or HHQ \compound{cmpd:HHQ} binds PqsR\cite{Xiao2006}, and this complex upregulates the synthesis of HHQ \compound{cmpd:HHQ}, as well as RhlR, so the Pqs system has control over the Rhl system.
Production of both PqsR and PqsH is also upregulated by the LasR complex, and so the Las system has control over the Pqs system.
The PqsR complex can also upregulate the production of blah\cite{blah}.

Add AI2\cite{Li2015a,Li2017} Increases biofilm and virulence by joining in with las/rhl, exact mechanism not known

Basically it's all very complicated.
Autoinducers needed for important behaviours.


%Hassett1999
%Genes or proteins under control of LasR: the second tier %(alphabetical). apr, encoding alkaline protease (Gambello et al., 1993);
%fagA±fumC±orfX±sodA operon, with the ®nal gene encoding Mn-SOD (this study); 
%haemolysin (Lati® et al., 1996); 
%katA , encoding KatA (thisstudy); 
%%lasA , encoding a staphylolytic protease (Lati® et al., 1996); 
%%lasB, encoding elastase (Passad or et al., 1993); 
%%lasI, encoding LasI, aprotein that catalyses the synthesis of PAI-1 from acyl±acyl carrier proteins and S-adenosylmethionine (Pesci et al., 1997); 
%%rhlR encodingRhlR, the second QS transactivator (Ochsner and Reiser, 1995); 
%twitching motility (Glessner et al., 1999; Suh et al., 1999); 
%%toxA , encodingexotoxin A (Gambello et al., 1993); 
%xcpP±xcpR (Chapon-Herve et al., 1997).
%
%Genes or proteins under the control of RhlR: the third tier (alpha betical). 
%Chitinase (Winson et al., 1995); 
%katA (this study); 
%%%lasB (Brint andOhman, 1995); 
%lipase (Reimmann et al., 1997); 
%%%pyocyanin (Brint and Ohman, 1995 , p. 1402); 
%%%rhlAB, encoding a rhamnosyltransferaseinvolved in the synthesis of the rhamnolipid surfactant; 
%%%rhlI, encoding RhlI, a protein that catalyses the synthesis of PAI-2 from acyl±acylcarrier proteins and S-adenosylmethionine (Pesci et al., 1997); 
%sodB, encoding Fe-SOD (potentially indirect control as indicated by `otherfactors?' in ®gure, this study); 
%xcpP-xcpR (Chapon-Herve et al., 1997).
%LecA,HCN,alkaline proteases
%
%
...
%
%
%\todo{add biofilm to diagram, late and early development Sauer2002,Davies1998,Dubern2008}
%PQS early biofilm\cite{Diggle2003,Hodgkinson2011}
%
%%Vfr\cite{Albus1997}
...
Specifically, C$_4$-HSL \compound{cmpd:HL4}, HHQ \compound{cmpd:HHQ} and PQS \compound{cmpd:PQS} derivatives were chosen as they were deemed most synthetically tractable.
