...
\noindent{\textbf{$^{1}$H NMR} (400 MHz, MeOD) $\delta$ / ppm = 
	...
	2.69 (t, \textit{J} = 7.7 Hz, 2 H, NHCC\underline{H}$_2$), 
	1.68 (quin, \textit{J} = 7.6 Hz, 2 H, NHCCH$_2$C\underline{H}$_2$), 
	1.28 - 1.39 (m, 4 H, NHCCH$_2$CH$_2$C\underline{H}$_2$C\underline{H}$_2$), 
...
\\[1\baselineskip]
\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = 223 (\ce{H2O})}
%rough
\\[1\baselineskip]
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ =
	3436.01 (N-H),
...
%\\[1\baselineskip]
%\noindent{\textbf{$^{13}$C NMR} (101 MHz, DMSO-d$_6$) $\delta$ / ppm = pending}
%\\[1\baselineskip]
...
%\noindent{\textbf{$^{13}$C NMR} (101 MHz, DMSO-d$_6$) $\delta$ / ppm = pending}
%\\[1\baselineskip]
%\noindent{\textbf{HRMS} (ESI$^+$) \textit{m}/\textit{z} / Da = pending, [M+H]$^+$, [\ce{C16H21N4O2}]$^+$ requires 301.1659
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = -30.0 (\textit{c} / g(100 mL)$^{-1}$ = 0.02 , DMSO)
\\[1\baselineskip]
...
(\textit{S})-3-Aminodihydrofuran-2(3\textit{H})-one hydrobromide \compound{cmpd:HLHBr} (100 mg, 0.549
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = 27.0 (\textit{c} / g(100 mL)$^{-1}$ = 0.0074 , \ce{CHCl3})
\\[1\baselineskip]
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{20}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = -32.6 (\textit{c} / g(100 mL)$^{-1}$ = 0.043 , DMSO)
\\[1\baselineskip]
The data are consistent with the literature\cite{Stacy2013}.
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{26.6}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = - 78 (\textit{c} / g(100 mL)$^{-1}$ = 0.08333 , MeOH)
...
\\[1\baselineskip]
\noindent{[\bm{$\alpha$}]$_D^{26.6}$ / $^{\circ}$10$^{-1}$cm$^2$g$^{-1}$ = - 16 (\textit{c} / g(100 mL)$^{-1}$ = 0.20833 , MeOH)
...
\noindent{\textbf{$^{1}$H NMR} (500 MHz, DMSO-d$_6$) $\delta$ / ppm = 
	...
	3.45 (br. t, J=11.6 Hz, 2 H, CH$_2$CH$_2$CH$_2$N(CH$_2$CH$_2$)CH$_2$C\underline{H}$_2$), 
	...
	2.84 (t, J=2.7 Hz, 1 H, \underline{H}C$\equiv$C), 
	2.24 (td, J=7.0, 2.7 Hz, 2 H, HC$\equiv$CC\underline{H}$_2$), 
	1.83 (br. quin, J=7.5 Hz, 2 H, HC$\equiv$CCH$_2$CH$_2$C\underline{H}$_2$), 
	1.52 (quin, J=7.4 Hz, 2 H, HC$\equiv$CCH$_2$C\underline{H}$_2$), 
...
\noindent{\textbf{$^{13}$C NMR} (126 MHz, DMSO-d$_6$) $\delta$ / ppm = 
	...
	152.8 (d, J=248.5 Hz, \textit{ipso} to F), 
	148.2 (\underline{C}HCC(=O)OH), 
	143.7 (d, J=11.1 Hz, \textit{para} to C(=O)), 
	139.1 (\textit{para} to F), 
	119.4 (d, J=6.9 Hz, \textit{ipso} to C(=O)), 
	111.2 (d, J=22.5 Hz, \textit{ortho} to F and \textit{ortho} to C(=O)), 
