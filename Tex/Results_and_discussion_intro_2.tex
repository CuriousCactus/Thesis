...
The analogues were linked to ciprofloxacin \compound{cmpd:Cip} in two ways: directly using either an S$_N$2 reaction or peptide coupling with methyl ciprofloxacin \compound{cmpd:CipMe}, and via the triazole linkage shown previously with ciprofloxacin \compound{cmpd:Cip} (see \ref{sec:Tris}).
...
As Ganguly \textit{et al.}\cite{Ganguly2011}  (see \ref{sec:AIA_intro}) synthesised their conjugate from Br-C$_4$-HCTL, it was envisaged that a branching strategy could be used to produce two sets of conjugates (see \ref{sch:branching_synth_general}). The first set would be formed by the S$_N$2 reaction of the relevant bromide with methyl ciprofloxacin \compound{cmpd:CipMe}. The second set would be made by displacing the bromide with azide, then performing a click reaction with the alkynyl ciprofloxacin derivative \compound{cmpd:Y4Cip} made previously to form the triazole-linked product. Cyclohexanone conjugates would be formed by oxidation of the alcohol conjugates.
