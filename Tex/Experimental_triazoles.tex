...
Azide (1 eq.) and alkyne (1 eq.) were dissolved in 50 \% \textit{t}-BuOH/water in a round-bottomed flask with a stirrer bar, closed with a \textit{new} septum. The mixture was degassed by bubbling through \ce{N2}. The mixture was placed under positive pressure of Ar using a balloon. 
Equimolar amounts of \ce{CuSO4.5H2O} and THPTA \compound{cmpd:THPTA} were dissolved in similar water to make a 50 mM solution and similarly degassed.
...
Other conjugates were purified by preparatory HPLC (5-95 \% acetonitrile (0.1 \% TFA)/water (0.05 \% TFA) over 20 min).
