...
\\[1\baselineskip]
\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = 238 (water, decomposes)}
\\[1\baselineskip]
...
\compound{cmpd:HL2T4Cip} was obtained as a white amorphous solid (8.8 mg, 14.8 $\mu$mol, 30\%).
\\[1\baselineskip]
...
The combined pure fractions were dried with \ce{MgSO4} and evaporated under reduced pressure.
\compound{cmpd:HL4T4Cip} was obtained as a white amorphous solid (14.6 mg, 23.4 $\mu$mol, 47\%).
\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
The mixture was stirred at r.t. under argon for 3 h, then dry-loaded onto \ce{SiO2} and purified by column chromatography using a Combiflash (\ce{SiO2}, 0-20\% MeOH/\ce{CH2Cl2} over 15 min)
The combined pure fractions were dried with \ce{MgSO4} and evaporated under reduced pressure.
\compound{cmpd:HL6T4Cip} was obtained as a white amorphous solid (12.4 mg, 19.0 $\mu$mol, 38\%).
\\[1\baselineskip]
...
\compound{cmpd:6HHQT4Cip} was obtained as a white amorphous solid (8.6 mg, 2.7 $\mu$mol, 27\%). %rough
\\[1\baselineskip]
%\noindent{\textbf{TLC} \textit{R$_f$} = ?? (??)}
%\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
\noindent{\textbf{IR} (neat) $\nu_{max}$ / cm$^{-1}$ = 
	...
	2927 (C-H),
	2866 (C-H),
	1716 (carboxylic acid C=O),
	%1673 \todo{is this TFA? redo}
	1631 (ciprofloxacin quinolone C=O and HHQ C=O)}
\\[1\baselineskip]
...
The combined pure fractions were dried with \ce{MgSO4} and evaporated under reduced pressure.
\compound{cmpd:HL4T4Tri} was obtained as a pale brown gum (4.8 mg, 8.4 $\mu$mol, 17\%, purity 77\% by NMR, contaminant was \compound{cmpd:HL4N3}).
\\[1\baselineskip]
\noindent{\textbf{TLC} \textit{R$_f$} = 0.30 (30\% MeOH/\ce{CH2Cl2})}
\\[1\baselineskip]
%\noindent{\textbf{mp} \textit{T} / $^{\circ}$C = ?? (??)}
...
The combined pure fractions were dried with \ce{MgSO4} and evaporated under reduced pressure.
\compound{cmpd:HL6T4Tri} was obtained as a clear gum (8.0 mg, 13.4 $\mu$mol, 27\%).
\\[1\baselineskip]
...
The combined pure fractions were evaporated under reduced pressure and then partitioned between \ce{NaHCO3} (aq., sat., 10 mL) and 10\% \textit{i}-PrOH/\ce{CHCl3} (10 mL). The organic layer was dried with \ce{MgSO4} and evaporated under reduced pressure.
\compound{cmpd:6HHQT4Tri} was obtained as a clear gum (2.6 mg, 4.1 $\mu$mol, 41\%).
\\[1\baselineskip]
...
The combined pure fractions were dried with \ce{MgSO4} and evaporated under reduced pressure. 
\compound{cmpd:PQST4Tri} was obtained as a pale brown amorphous solid (4.7 mg, 7.3 $\mu$mol, 18\%).
\\[1\baselineskip]
