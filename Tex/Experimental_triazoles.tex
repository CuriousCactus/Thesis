...
\noindent{\textbf{$^{13}$C NMR} (126 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	47.9 (NHC(=O)CH$_2$\underline{C}H$_2$), 
	35.9 (N\underline{C}H(CH$_2$)$_2$), 
...
\subsection{(\textit{S})-4-(4-(4-(4-((2,4-Diaminopyrimidin-5-yl)methyl)-2,6-dimethoxyphenoxy)butyl)-1H-1,2,3-triazol-1-yl)-\textit{N}-(2-oxotetrahydrofuran-3-yl)butanamide \compound{cmpd:HL4T4Tri}}
...
\subsection{(\textit{S})-6-(4-(4-(4-((2,4-Diaminopyrimidin-5-yl)methyl)-2,6-dimethoxyphenoxy)butyl)-1H-1,2,3-triazol-1-yl)-\textit{N}-(2-oxotetrahydrofuran-3-yl)hexanamide \compound{cmpd:HL6T4Tri}}
...
\noindent{\textbf{$^{1}$H NMR} (500 MHz, DMSO d$_6$) $\delta$ / ppm = 
	...
	3.80 (t, \textit{J} = 6.3 Hz, 2 H, C\underline{H}$_2$O), 
