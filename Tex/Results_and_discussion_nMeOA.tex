...
\subsection{Synthesis of the 2-Methoxybenzene conjugates\label{sec:2MeO}}
...
\begin{scheme}[H]
	\begin{center}
		...
		a) \ce{NaHCO3}, \ce{CH2Cl2}, water, 0 $^{\circ}$C, 1 h, 50\%.
...
\ce{N3}-C$_4$-2-methoxybenzene \compound{cmpd:2MeOA4N3} was synthesised from Br-C$_4$-2-methoxybenzene \compound{cmpd:2MeOA4Br} by an S$_N$2 reaction with sodium azide (see \ref{sch:2MeOA4T4Cip_synth}). The yield of \ce{N3}-C$_4$-2-methoxybenzene \compound{cmpd:2MeOA4N3} (27\%) was a lot lower than for \ce{N3}-C$_4$-HCTL \compound{cmpd:SHL4N3} (89\%). However, in this case it may not be better to use the product crude as several impurities were formed during the reaction and could be observed by LCMS (see \ref{fig:2MeOA4N3_impurities}).
...
\begin{scheme}[H]
	\begin{center}
		...
		b) \ce{CuSO4}, THPTA, sodium ascorbate, water, \textit{t}-BuOH, \ce{CH2Cl2}, r.t., 16 h, 39\%.\label{sch:2MeOA4T4Cip_synth}}
	\end{center}
\end{scheme}

\subsection{Synthesis of the 3-Methoxybenzene conjugates}
...
\begin{scheme}[H]
	\begin{center}
		...
		\caption{Synthesis of Br-C$_4$-3-methoxybenzene \compound{cmpd:2MeOA4Br}.
			a) \ce{NaHCO3}, \ce{CH2Cl2}, water, 0 $^{\circ}$C, 1 h, 50\%. \label{sch:3MeOA4Br_synth}}
	\end{center}
\end{scheme}
...
\begin{scheme}[H]
	\begin{center}
		...
		b) \ce{CuSO4}, THPTA, sodium ascorbate, water, \textit{t}-BuOH, \ce{CH2Cl2}, r.t., 2 h, 5\%. 
