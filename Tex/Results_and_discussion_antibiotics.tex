\subsection{Synthesis of the alkynyl antibiotic derivatives}
...
\begin{scheme}[H]
	\begin{center}
		...
		c) TFA, r.t., 1 h, >99\%.
		d) NMP, microwave, 115 $^{\circ}$C 24 h, 12\%.
...
\begin{scheme}[H]
	\begin{center}
		...
		a) HBr (aq.), 100 $^{\circ}$C, 40 min, 43\%. 
		b) \ce{Cs2CO3}, DMF, 70 $^{\circ}$C, 7 h, 25\%.
